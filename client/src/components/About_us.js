...
const About_us = () => {
	return (
		<div className="row">
			<h1>About us</h1>
			<p>
				Our class register web app project is designed to simplify the task of
				keeping track of cohort attendance and sessions. With its user-friendly
				interface, volunteers can easily create and manage class schedules and
