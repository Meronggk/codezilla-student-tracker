...
function About_us () {
  ...
  return (
    <div style={{ backgroundColor: "darkgrey", minHeight: "100vh", color: "black" }} className="about_cont">
 ...
 Codezilla Group
      ...
      {showMembers && (
        <div style={{ display: "flex", justifyContent: "center", color: "black" }}>
          {teamMembers.map((member) => (
            <div key={member.id} style={{ textAlign: "center", margin: "20px", color: "black" }}>
              <img
                src={member.image.default}
                alt={member.name}
                style={{ width: "150px", height: "150px", borderRadius: "10%", color: "black" }}
              />
              <h3>
      ...
      {showProject && (
        <>
          <h2 style={{ textAlign: "center", marginTop: "100px", color: "black" }}>OUR PROJECT</h2>
